...
##base_antenna = readAntenna('1Y-4EL.csv'); # Not good, creates several "phanton" passive elements
...
for i = 1:length(s)
  ...
  displayResults(array_1, field_name, plot_type,'showImages','off', 'printImages', true, 'savedir', '/media/vitinho/DADOS/TCC/Octave/Validation/Images/Array_1/', 'close_after', true);
  displayResults(antv_1, field_name, plot_type,'showImages','off', 'printImages', true, 'savedir', '/media/vitinho/DADOS/TCC/Octave/Validation/Images/Array_1/', 'close_after', true);
  displayResults(array_2, field_name, plot_type,'showImages','off', 'printImages', true, 'savedir', '/media/vitinho/DADOS/TCC/Octave/Validation/Images/Array_2/', 'close_after', true);
  displayResults(antv_2, field_name, plot_type,'showImages','off', 'printImages', true, 'savedir', '/media/vitinho/DADOS/TCC/Octave/Validation/Images/Array_2/', 'close_after', true);
  displayResults(array_3, field_name, plot_type,'showImages','off', 'printImages', true, 'savedir', '/media/vitinho/DADOS/TCC/Octave/Validation/Images/Array_3/', 'close_after', true);
  displayResults(antv_3, field_name, plot_type,'showImages','off', 'printImages', true, 'savedir', '/media/vitinho/DADOS/TCC/Octave/Validation/Images/Array_3/', 'close_after', true);
  displayResults(array_4, field_name, plot_type,'showImages','off', 'printImages', true, 'savedir', '/media/vitinho/DADOS/TCC/Octave/Validation/Images/Array_4/', 'close_after', true);
  displayResults(antv_4, field_name, plot_type,'showImages','off', 'printImages', true, 'savedir', '/media/vitinho/DADOS/TCC/Octave/Validation/Images/Array_4/', 'close_after', true);
  displayResults(array_5, field_name, plot_type,'showImages','off', 'printImages', true, 'savedir', '/media/vitinho/DADOS/TCC/Octave/Validation/Images/Array_5/', 'close_after', true);
  displayResults(antv_5, field_name, plot_type,'showImages','off', 'printImages', true, 'savedir', '/media/vitinho/DADOS/TCC/Octave/Validation/Images/Array_5/', 'close_after', true);
end

disp(['Time elapsed for calculating ',array_1.Name,': ',num2str(array_1_time),' seconds']);
disp(['Time elapsed for calculating ',array_2.Name,': ',num2str(array_2_time),' seconds']);
disp(['Time elapsed for calculating ',array_3.Name,': ',num2str(array_3_time),' seconds']);
disp(['Time elapsed for calculating ',array_4.Name,': ',num2str(array_4_time),' seconds']);
disp(['Time elapsed for calculating ',array_5.Name,': ',num2str(array_5_time),' seconds']);
