tic;
##base_ant = readAntenna('Dipolo.csv');
base_ant = idealDipoleAntenna(-180, 180, 91, 0, 180, 91);
...
tg_ant = resample(tg_ant, 0, 180, 91, -180, 180, 91);
tg_ant = evaluateArray(tg_ant);
arr = resample(arr, 0, 180, 91, -180, 180, 91);
arr = evaluateArray(arr);
