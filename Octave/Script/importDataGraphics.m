...
function polar3d(ant, field_name, showIm)
  figure('visible', showIm, 'filename', ['polar3d ', field_name]);
  hold on;
...
function invertedSphere_rE(ant, field_name, showIm)
  figure('visible', showIm, 'filename', ['inverted sphere ', field_name]);
  hold on;
...
##  title("inverted sphere rE");
  set(gcf, 'filename', [ant.Name,' inverted sphere ', field_name])
  grid off;
  axis off;
end
