function ant = toMeshShape(ant)
  ...
  ant.k_hat = permute(reshape(ant.k_hat, [3, mesh_shape]), ...
    [3,2,1]);
  ant.theta_hat = permute(reshape(ant.theta_hat, [3, mesh_shape]), ...
    [3,2,1]);
  ant.phi_hat = permute(reshape(ant.phi_hat, [3, mesh_shape]), ...
    [3,2,1]);
