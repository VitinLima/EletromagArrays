...
def run(elevation=0, azimuth=0, roll=0, Ntheta=91, Nphi=91):
    ...
    hfss_yagi1EL_V.set_current(current_phase=90);
    ...
    hfss_yagi2EL_V.set_current(current_phase=90);
    ...
    hfss_yagi3EL_V.set_current(current_phase=90);
    ...
    hfss_yagi4EL_V.set_current(current_phase=90);
