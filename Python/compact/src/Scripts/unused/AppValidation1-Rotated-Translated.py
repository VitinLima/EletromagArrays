# -*- coding: utf-8 -*-
"""
Created on Wed May 24 15:22:13 2023
...
hfss_yagi4EL.set_position(x=0,y=1.5,z=0)

array_1Y4EL = Array.Array(name='Array 1Y4El Translated',
                          theta=theta.copy(),
                          phi=phi.copy(),
                          antennas=[hfss_yagi4EL])
array_1Y4EL.antennas[0].set_orientation(roll=0, elevation=0, azimuth=45)
array_1Y4EL.antennas[0].set_position(x=0.0, y=1.5, z=0)
array_1Y4EL.evaluate()

file_name = '1Y-4EL-Rotated-Translated.csv'
file_path = os.path.join(antennas_dir, file_name)
hfss_yagi4EL_R_T = Antenna.load_from_file(file_path,
                                      name='HFSS Y4EL R-T',
                                      theta=theta,
                                      phi=phi,
                                      load_mesh_from_file=False)
...
app.add_antenna(hfss_yagi4EL_R_T)
