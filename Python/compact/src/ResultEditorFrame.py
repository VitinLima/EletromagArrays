...
class ResultEditorFrame(ttk.Frame):
    ...
    def _on_update(self):
        ...
        self.result.in_dB = self.in_dB_variable.get() is True
        self.result.dynamic_scaling_dB = self.dynamic_scaling_dB_variable.get()
        self.result.visible_flag = self.visible_flag_variable.get() is True
        self.result.axis_flag = self.axis_flag_variable.get() is True
        self.result.grid_flag = self.grid_flag_variable.get() is True
