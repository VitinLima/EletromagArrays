...
class AntennaEditorFrame(tk.Frame):
    ...
    def init_variables(self,):
        ...
        self.current_magnitude = tk.DoubleVar(value=self.antenna.current_magnitude)
    ...
    def init_layout(self):
        ...
        ttk.Label(master=fr3, text='Elevation',width=12).pack(side='left',fill='y')
        ttk.Entry(master=fr3, textvariable=self.elevation,width=10,justify="center").pack(side='right',fill='y')
        fr3 = tk.Frame(master=fr2,border=2)
        fr3.pack(side='top',fill='both')
        ttk.Label(master=fr3, text='Azimuth',width=12).pack(side='left',fill='y')
        ttk.Entry(master=fr3, textvariable=self.azimuth,width=10,justify="center").pack(side='right',fill='y')
        fr3 = tk.Frame(master=fr2,border=2)
        fr3.pack(side='top',fill='both')
        ttk.Label(master=fr3, text='Roll',width=12).pack(side='left',fill='y')
        ttk.Entry(master=fr3, textvariable=self.roll,width=10,justify="center").pack(side='right',fill='y')
        
        fr2 = ttk.LabelFrame(master=fr, text='Position')
        fr2.pack(side='top',fill='both')
        fr3 = tk.Frame(master=fr2,border=2)
        fr3.pack(side='top',fill='both')
        ttk.Label(master=fr3, text='X',width=3).pack(side='left',fill='y')
        ttk.Entry(master=fr3, textvariable=self.x,width=10,justify="center").pack(side='right',fill='y')
        fr3 = tk.Frame(master=fr2,border=2)
        fr3.pack(side='top',fill='both')
        ttk.Label(master=fr3, text='Y',width=3).pack(side='left',fill='y')
        ttk.Entry(master=fr3, textvariable=self.y,width=10,justify="center").pack(side='right',fill='y')
        fr3 = tk.Frame(master=fr2,border=2)
        fr3.pack(side='top',fill='both')
        ttk.Label(master=fr3, text='Z',width=3).pack(side='left',fill='both')
        ttk.Entry(master=fr3, textvariable=self.z,width=10,justify="center").pack(side='right',fill='both')
    ...
    def _on_update(self):
        ...
        self.antenna.set_current(magnitude = self.current_magnitude.get(),
                                 phase = self.current_phase.get())
        
        self.antenna.set_position(x=self.x.get(),y=self.y.get(),z=self.z.get())
