...
tab_1 = ResultFrame.ResultFrame(master=app.tabs,name='Phase',columns=2)
...
tab_2 = ResultFrame.ResultFrame(master=app.tabs,name='Mag',columns=2)
...
field='Ftheta'
color='Color by phase'
tab_3 = ResultFrame.ResultFrame(master=app.tabs,name='Phase 2',columns=2)
