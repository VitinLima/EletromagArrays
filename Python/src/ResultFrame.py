...
class ResultFrame(tk.Frame):
    def __init__(self,master=None,name='New tab',iy=1,columns=1,rows=1,**kw):
    ...
    def request_axes(self, requester, projection, preferred_position=None,column=None,row=None, **kw):
        ...
        #         position = (row - 1)*self.columns + column
        #         self.axes_dict[requester] = self.figure.add_subplot(self.columns,self.rows,position,projection=projection,**kw)
        #     else:
        ...
        # else:
        #     if str(type(preferred_position))=="<class 'tuple'>":
        #         flag = True
