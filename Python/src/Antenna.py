...
class Antenna:
    ...
    def evaluate_local_field(self):
        ...
        local_max_F = np.max(self.local_F)
        if local_max_F>1e-14:
            self.local_F = self.local_F/local_max_F;
            self.local_Ftheta = self.local_Ftheta/local_max_F;
            self.local_Fphi = self.local_Fphi/local_max_F;
