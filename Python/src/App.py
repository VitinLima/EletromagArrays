...
if __name__ == "__main__":
    ...
    try:
        ...
        #       str(round(antennas['array_validation_1Y4EL'].evaluation_time*100000)/100) + 'ms')
        # print('Evaluation time of 2Y-4El: ' + \
        #       str(round(antennas['array_validation_2Y4EL'].evaluation_time*100000)/100) + 'ms')
        # print('Evaluation time of 3Y-4El: ' + \
        #       str(round(antennas['array_validation_3Y4EL'].evaluation_time*100000)/100) + 'ms')
        # print('Evaluation time of 4Y-4El: ' + \
        #       str(round(antennas['array_validation_4Y4EL'].evaluation_time*100000)/100) + 'ms')
        # print('Evaluation time of 5Y-4El: ' + \
        #       str(round(antennas['array_validation_5Y4EL'].evaluation_time*100000)/100) + 'ms')
