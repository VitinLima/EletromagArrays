...
array_2Y4EL = Array.Array(name='Array 2Y4El',
                          theta=theta.copy(),
                          phi=phi.copy(),
...
array_2Y4EL.antennas[0].set_orientation(roll=0, elevation=0, azimuth=0)
array_2Y4EL.antennas[0].set_position(x=0.0, y=0.0, z=0)
array_2Y4EL.antennas[1].set_orientation(roll=0, elevation=0, azimuth=45)
array_2Y4EL.antennas[1].set_position(x=0.0, y=1.5, z=0)
# array_2Y4EL.antennas[2].set_orientation(roll=0, elevation=-45, azimuth=-45)
# array_2Y4EL.antennas[2].set_position(x=0, y=-1.5, z=0)
# array_2Y4EL.antennas[3].set_orientation(roll=0, elevation=-45, azimuth=135)
# array_2Y4EL.antennas[3].set_position(x=0.34, y=-3.14, z=1.423)
# array_2Y4EL.antennas[4].set_orientation(roll=0, elevation=72, azimuth=14)
