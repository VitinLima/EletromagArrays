...
def run(app, antennas):
    ...
    Scripts.LoadDefaultGraphs.load_default_graphs(app=app,name='Validation 2Y-4El',antenna=antennas['array_validation_2Y_4El'])
    Scripts.LoadDefaultGraphs.load_default_graphs(app=app,name='Validation 3Y-4El',antenna=antennas['array_validation_3Y_4El'])
